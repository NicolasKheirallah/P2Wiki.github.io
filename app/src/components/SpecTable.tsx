    ...
    ScrollTrigger.batch('.spec-row', {
      ...
      onEnter: (batch) => {
        gsap.fromTo(
          batch,
          { opacity: 0, y: 10 },
          { opacity: 1, y: 0, duration: 0.3, stagger: 0.015, ease: 'power2.out', overwrite: true }
        );
      },
      start: 'top 95%',
    });
          ...
          <div className="overflow-x-auto scrollbar-hide -mx-2 px-2">
            <table className="w-full min-w-[800px] border-collapse">
              <thead className="sticky top-14 z-30 border-b border-[var(--ps-table-border)]">
                <tr>
                  <th
                    className="sticky left-0 bg-[var(--ps-bg)] text-left py-3 pr-4 text-[12px] font-normal uppercase tracking-wider w-[260px] min-w-[200px] z-40 border-r border-[var(--ps-border-light)] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]"
                  ...
                  <th
                    className="text-left py-3 pl-4 text-[12px] font-normal w-[220px] min-w-[180px] bg-[var(--ps-bg)]"
                    style={{ color: 'var(--ps-text-tertiary)' }}
                  >
                    {t('notes')}
                  </th>
